...
/******************************************************************************
      Function description: LCD serial data write function
       Parameters: serial data to be written to dat
       Return value: None
******************************************************************************/
...
/******************************************************************************
      Function description: LCD write data
       Parameters: data written by dat
       Return value: None
******************************************************************************/
...
/******************************************************************************
      Function description: LCD write command
       Parameters: command written by dat
       Return value: None
******************************************************************************/
...
/******************************************************************************
      Function description: Set start and end addresses
       Parameters: x1, x2 set the start and end addresses of the column
...
void Lcd_Init(void)
{
	...
	LCD_WR_REG(0x36);
	if(ORIENTATION==0)LCD_WR_DATA8(0x08);
	else if(ORIENTATION==1)LCD_WR_DATA8(0xC8);
	else if(ORIENTATION==2)LCD_WR_DATA8(0x78);
...
/******************************************************************************
      Function description: LCD display Chinese characters
       Parameters: x, y starting coordinates
...
{  
  ...
  size1=size*size/8;//The byte occupied by a Chinese character
...
/******************************************************************************
      Function description: LCD draw small dot
       Parameters: x, y - starting coordinates
	   			   color - dot color
       Return value: None
******************************************************************************/
...
/******************************************************************************
      Function description: LCD draw large dot
       Parameters: x, y - starting coordinates
	   			   color - dot color
       Return value: None
******************************************************************************/
...
/******************************************************************************
      Function description: fill color in the specified area
       Parameters: xsta, ysta starting coordinates
...
{          
	u16 i,j; 
	LCD_Address_Set(xstart,ystart,xend,yend);      //set cursor position
	for(i = ystart; i<=yend; i++)
	{													   	 	
		for(j=xstart; j<=xend; j++) LCD_WR_DATA(color); //set cursor position
	} 					  	    
}
...
void LCD_DrawLine(u16 x1,u16 y1,u16 x2,u16 y2,u16 color)
{
	...
	{
		LCD_DrawPoint(uRow,uCol,color);//Draw points
		xerr+=delta_x;
		yerr+=delta_y;
		if(xerr>distance)
		{
...
/******************************************************************************
      Function description: draw circle
       Parameters: x0, y0 center coordinates
                 r radius
       Return value: None
******************************************************************************/
...
void LCD_ShowPicture(u16 x1,u16 y1,u16 x2,u16 y2)
{
	...
	{ 	
		...
		// Likely changed due to image.bin formatting change
		LCD_WR_DATA8(image[i]);
	}			
}

/******************************************************************************
      Function description: display logo
       Parameters: None
       Return value: None
******************************************************************************/
